...
public class MainActivity extends AppCompatActivity {
    ...
    public static int server_port_string = 8080;
    public static String server_ip_string = "10.0.2.16";
    private Thread thread;
    private Handler handler;
    private LinearLayout message_List_view;
    private int clientTextColor;
    private TextView textView1;
    private ClientThreadForConnectingToServer client_thread;
    private EditText Message_to_print;
    private static String packageName2;

    //Client side message need to to be on screen untill client close his/her application... its under development...
    @Override
    ...
    private class ClientThreadForConnectingToServer implements Runnable {
        ...
        //Overide method will be called auto...
        @Override
        public void run() {
            try {
